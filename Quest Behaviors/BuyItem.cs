...
{
    [XmlElement("BuyItem")]
    public class BuyItem : ProfileBehavior
    {
        ...
        protected override Composite CreateBehavior()
        {
            return new PrioritySelector(
                ...
                new Decorator(r => SelectIconString.IsOpen, new Action(r =>
                {
                    ...
                    if (DialogOption == -1)
                    {
                        TreeRoot.Stop("No DialogOption supplied, but found dialog window.");
                        throw new ArgumentException("No DialogOption supplied, but found dialog window.");
