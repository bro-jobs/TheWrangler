...
{
    public class SmallDutyCombatTargetingProvider : ITargetingProvider
    {
        public readonly HashSet<int> IgnoredIds;
        public SmallDutyCombatTargetingProvider(int[] idstoignore)
        {
        ...
        public List<BattleCharacter> GetObjectsByWeight()
        {
            ...
            BattleCharacter guardianNpc = GameObjectManager.GetObjectByNPCId<BattleCharacter>(SimpleDutyTag.StaticGuardianNPCId);
        ...
        private bool IsValidUnit(bool incombat, BattleCharacter unit, BattleCharacter guardian, HotSpot[] hotspots)
        {
            ...
            if (guardian != null)
            {
                if (guardian.DistanceSqr(unit.Location) <= SimpleDutyTag.StaticSearchDistance * SimpleDutyTag.StaticSearchDistance)
                {
                    return true;
                }
            }
