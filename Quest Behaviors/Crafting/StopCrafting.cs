...
{
    [XmlElement("StopCrafting")]
    public class StopCrafting : ProfileBehavior
    {
        ...
        private async Task<bool> CloseWindow()
        {
            ...
            await Coroutine.Wait(Timeout.InfiniteTimeSpan, () => !MovementManager.IsOccupied);
        ...
        {
            return new ActionRunCoroutine(ctx => CloseWindow());
        }
    }
}
